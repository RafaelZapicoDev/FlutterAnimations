...
class StaggeredAnimationState extends State<StaggeredAnimation>
  ...
  late List<Animation<double>> _starRotateAnimations;
  ...
  void initState() {
    ...
    _animationController = AnimationController(
      vsync: this,
      duration: const Duration(milliseconds: 1105),
    );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppBar(nome: "Staggered Animations"),
                      ...
                      return AnimatedBuilder(
                        ...
                        builder: (context, child) {
                          return Transform.translate(
                            offset: Offset(0, _starJumpAnimations[index].value),
